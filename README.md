...
arjan-cli/0.2.1 linux-x64 node-v12.13.1
$ arjan --help [COMMAND]
USAGE
  $ arjan COMMAND
...
...
_See code: [src/commands/audit.js](https://github.com/arjan-tools/cli/blob/v0.2.1/src/commands/audit.js)_
...
_See code: [src/commands/deploy.js](https://github.com/arjan-tools/cli/blob/v0.2.1/src/commands/deploy.js)_
...
_See code: [src/commands/init.js](https://github.com/arjan-tools/cli/blob/v0.2.1/src/commands/init.js)_
...
_See code: [src/commands/localize.js](https://github.com/arjan-tools/cli/blob/v0.2.1/src/commands/localize.js)_
...
_See code: [src/commands/optimize.js](https://github.com/arjan-tools/cli/blob/v0.2.1/src/commands/optimize.js)_
...
_See code: [src/commands/upload.js](https://github.com/arjan-tools/cli/blob/v0.2.1/src/commands/upload.js)_
<!-- commandsstop -->
